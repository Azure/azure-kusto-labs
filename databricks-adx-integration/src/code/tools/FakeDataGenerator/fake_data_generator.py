"""
  ...
  1. This code is to create kusto multiple tenanent databased and tables
  """
import gzip
import json
import random
...
def create_log():
    ...
    # The company and type fields become the directory names the ingestion
    # function reads the destination database and table from, so they are drawn
    # from the same policy the databases and tables were created with.
